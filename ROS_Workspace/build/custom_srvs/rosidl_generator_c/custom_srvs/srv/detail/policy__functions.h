...
#ifndef CUSTOM_SRVS__SRV__DETAIL__POLICY__FUNCTIONS_H_
#define CUSTOM_SRVS__SRV__DETAIL__POLICY__FUNCTIONS_H_
 ...
 * calls
 * custom_srvs__srv__Policy_Request__init().
...
/**
 * It calls
 * custom_srvs__srv__Policy_Request__fini()
 ...
 * custom_srvs__srv__Policy_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_srvs__srv__Policy_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_srvs__srv__Policy_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_srvs
...
/**
 * It calls
 * custom_srvs__srv__Policy_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_srvs
...
/**
 * It allocates the memory for the array and calls
 * custom_srvs__srv__Policy_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_srvs
...
/**
 * It calls
 * custom_srvs__srv__Policy_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_SRVS__SRV__DETAIL__POLICY__FUNCTIONS_H_
