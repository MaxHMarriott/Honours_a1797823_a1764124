...
class UGV1Main(Node):
    ...
    def __init__(self):
        ...
        self.x = 0; #this will be the x coodinate of the agent retrieved from the navigation node.
        self.y = 0; #this will be the y coodinate of the agent retrieved from the navigation node.
        self.publisher = self.create_publisher(LEDLocationsMsg,Publisher_name,10)
    ...
    def subscribe_message(self,data):
        ...
        self.FireSeverity.FireX = self.x
        self.FireSeverity.FireY = self.y
        self.publisher.publish(FireSeverity)
