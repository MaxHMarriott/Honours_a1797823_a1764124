...
custom_msgs__msg__LEDLocations__are_equal(const custom_msgs__msg__LEDLocations * lhs, const custom_msgs__msg__LEDLocations * rhs)
{
  ...
  // led1x
  if (lhs->led1x != rhs->led1x) {
    return false;
  }
  // led2x
  if (lhs->led2x != rhs->led2x) {
    return false;
  }
  // led1y
  if (lhs->led1y != rhs->led1y) {
    return false;
  }
  // led2y
  if (lhs->led2y != rhs->led2y) {
    return false;
  }
  return true;
}
  ...
  custom_msgs__msg__LEDLocations * output)
{
  ...
  // led1x
  output->led1x = input->led1x;
  // led2x
  output->led2x = input->led2x;
  // led1y
  output->led1y = input->led1y;
  // led2y
  output->led2y = input->led2y;
  return true;
}
