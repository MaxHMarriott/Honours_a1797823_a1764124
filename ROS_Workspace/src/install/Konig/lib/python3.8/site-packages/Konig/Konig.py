...
class Konig(Node):
    ...
    def __init__(self):
        ...
        self.subscription6 = self.create_subscription(Image, "/UGV1Frame",self.UGV1Frame_Update, qos_profile_sensor_data)
        self.subscription7 = self.create_subscription(FireSeverityMsg, "/UGV1Detections", self.UGV1Detections_Update, qos_profile_sensor_data)
        #defining times:
        ...
        self.UGV1Frame_time = time()
        self.UGV1Detections_time = time()
        self.UAVVision_time = time()
        self.UGV1Vision_time = time()
        self.UGV2Vision_time = time()
        self.UAVProcessing_time = time()
        self.UGV1Processing_time = time()
        self.UGV2Processing_time = time()
        self.UAVMain_time = time()
        self.UGV1Main_time = time()
        self.UGV2Main_time = time()
    ...
    def UAVFrame_Update(self,data):
        self.UAVVision_time = time()
        self.UAVFrame_time = time()
        self.view.c31.config(text="Publishing")

    def UGV1Frame_Update(self,data):
        self.UGV1Vision_time = time()
        self.UGV1Frame_time = time()
        self.view.c41.config(text="Publishing")

    def UGV1Detections_Update(self,data):
        self.UGV1Processing_time = time()
        self.UGV1Detections_time = time()
        msg1 = str(data.isdetected)
        msg2 = data.severity
        self.view.c71.config(text=msg1)
        self.view.b91.config(text=msg2)

    def update_Times(self):
        self.view.t4.config(text=str(round(self.current_time-self.UGV1State_time,2)))
        self.view.t6.config(text=str(round(self.current_time-self.UAVState_time,2)))
        self.view.t7.config(text=str(round(self.current_time-self.UGV1Vision_time,2)))
        self.view.t9.config(text=str(round(self.current_time-self.UAVVision_time,2)))
        self.view.t10.config(text=str(round(self.current_time-self.UGV1Processing_time,2)))
        self.view.t12.config(text=str(round(self.current_time-self.UAVProcessing_time,2)))
        ...
        self.view.t15.config(text=str(round(self.current_time-self.UAVFrame_time,2)))
        self.view.t16.config(text=str(round(self.current_time-self.UGV1Frame_time,2)))
        self.view.t18.config(text=str(round(self.current_time-self.UAVDetections_time,2)))
        self.view.t19.config(text=str(round(self.current_time-self.UGV1Detections_time,2)))
        self.view.t21.config(text=str(round(self.current_time-self.UGV1Detections_time,2)))
...
class DisplayData(tk.Frame):
    def __init__(self, root):
        ...
        self.UGV1MainStatus = "Working"
        self.UGV2MainStatus = "Not Working"
        self.UAVMainStatus = "Working"
        self.UGV1VisionStatus = "Working"
        self.UGV2VisionStatus = "Not Working"
        self.UAVVisionStatus = "Working"
        self.UGV1ProcessingStatus = "Working"
        self.UGV2ProcessingStatus = "Not Working"
        self.UAVProcessingStatus = "Working"
        self.UGV1ProcessingStatus = "Working"
        self.UGV2ProcessingStatus = "Not Working"
        self.UAVProcessingStatus = "Working"
    ...
    def Display(self):
        ...
        self.columnconfigure([0,1,2], minsize=325)
        #Power
        ...
        self.c61 = tk.Label(self, text="Not detected", font=("Arial", 13))
        ...
        self.c7 = tk.Label(self, text="UGV1FireDetection:", font=("Arial", 13))
        self.c71 = tk.Label(self, text="Not detected", font=("Arial", 13))
        ...
        self.c8 = tk.Label(self, text="UGV2FireDetection:", font=("Arial", 13))
        self.c81 = tk.Label(self, text="Not detected", font=("Arial", 13))
        ...
        self.c9 = tk.Label(self, text="UGV1FireSeverity:", font=("Arial", 13))
        self.c91 = tk.Label(self, text="Not detected", font=("Arial", 13))
        self.c9.grid(row=23, column=0)
        self.c91.grid(row=23, column=1)
        self.t21 = tk.Label(self, text="-1", font=("Arial", 13))
        self.t21.grid(row=23, column=2)

        self.c10 = tk.Label(self, text="UGV2FireSeverity:", font=("Arial", 13))
        self.c101 = tk.Label(self, text="Not detected", font=("Arial", 13))
        self.c10.grid(row=24, column=0)
        self.c101.grid(row=24, column=1)
        self.t22 = tk.Label(self, text="-1", font=("Arial", 13))
        self.t22.grid(row=24, column=2)
