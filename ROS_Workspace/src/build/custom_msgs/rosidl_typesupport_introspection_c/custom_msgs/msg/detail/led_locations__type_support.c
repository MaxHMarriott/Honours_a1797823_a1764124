...
static rosidl_typesupport_introspection_c__MessageMember LEDLocations__rosidl_typesupport_introspection_c__LEDLocations_message_member_array[4] = {
  {
    "isled1",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs__msg__LEDLocations, led1),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs__msg__LEDLocations, led2),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
