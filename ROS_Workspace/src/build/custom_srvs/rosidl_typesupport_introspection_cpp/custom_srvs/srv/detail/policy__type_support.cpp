...
{
  new (message_memory) custom_srvs::srv::Policy_Request(_init);
}

void Policy_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_srvs::srv::Policy_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Policy_Request_message_member_array[2] = {
  {
    ...
    offsetof(custom_srvs::srv::Policy_Request, location),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_srvs::srv::Policy_Request, eta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Policy_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_srvs::srv::Policy_Request),
...
{
  return &::custom_srvs::srv::rosidl_typesupport_introspection_cpp::Policy_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_srvs, srv, Policy_Request)() {
  return &::custom_srvs::srv::rosidl_typesupport_introspection_cpp::Policy_Request_message_type_support_handle;
}
...
void Policy_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) custom_srvs::srv::Policy_Response(_init);
}

void Policy_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_srvs::srv::Policy_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Policy_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_srvs::srv::Policy_Response, ack),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Policy_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_srvs::srv::Policy_Response),
...
{
  return &::custom_srvs::srv::rosidl_typesupport_introspection_cpp::Policy_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_srvs, srv, Policy_Response)() {
  return &::custom_srvs::srv::rosidl_typesupport_introspection_cpp::Policy_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Policy_service_members = {
  ...
  // see get_service_type_support_handle<custom_srvs::srv::Policy>()
...
get_service_type_support_handle<custom_srvs::srv::Policy>()
{
  ...
  auto service_type_support =
    &::custom_srvs::srv::rosidl_typesupport_introspection_cpp::Policy_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_srvs, srv, Policy)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<custom_srvs::srv::Policy>();
}
